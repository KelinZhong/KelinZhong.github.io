      ...
      <aside className={`fixed inset-0 md:static md:inset-auto md:w-72 bg-white border-r border-slate-200 p-6 flex flex-col z-40 transition-transform duration-300 ease-in-out ${isMenuOpen ? 'translate-x-0' : '-translate-x-full md:translate-x-0'}`}>
        <div className="mb-10 text-center md:text-left">
          ...
          <div className="flex flex-wrap gap-2 mt-6 justify-center md:justify-start">
            ...
            {userData.profile.social.scholar && ( <a href={userData.profile.social.scholar} target="_blank" rel="noopener noreferrer"  className="flex items-center px-3 py-2 bg-sky-700 text-white rounded-md hover:bg-sky-800 transition-colors text-sm font-medium"> <GoogleScholar size={16} className="mr-2"/> Scholar
  </a>
)}
          </div>
