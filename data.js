export const userData = {
    profile: {
      ...
      bio: "Applied data scientist and quantitative modeler with 2+ years of experience building predictive models, causal inference pipelines, and statistical modeling solutions for large-scale real-world data. Skilled in feature engineering, model validation, uncertainty quantification, and translating complex analyses into decision-ready insights for cross-functional stakeholders. Hands-on experience with Python, R, PyTorch, SQL, Stan, Git, Linux, and reproducible analytics.",
      location: "Vernon, CT",
